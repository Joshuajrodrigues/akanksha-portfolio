...
export default function Home() {
  return (
    <main className=" relative  m-8 flex  flex-col">
      ...
      <section className="panel mt-8 min-h-svh ">
      ...
      <section className="panel mt-8 min-h-svh flex flex-col justify-between items-center">
        <div>
